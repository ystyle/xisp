...
(println "2. 链式列表操作")
(println "代码: (-> [1 2 3 4 5] (rest) (rest) (first))")
(println "等价于: (first (rest (rest '(1 2 3 4 5))))")
(define r2 (-> [1 2 3 4 5] (rest) (rest) (first)))
(println #"结果: #{r2}")
(println "期望: 3")
(println "")

(println "3. 与高阶函数结合")
(println "代码: (-> [1 2 3 4 5] (map (lambda (x) (* x x))) (filter (lambda (x) (> x 5))) (reduce + 0))")
...
(println "代码: (-> [1 2 3 4 5] (apply +))")
(println "说明: apply + 到列表 (1 2 3 4 5) => 15")
(define r6 (-> [1 2 3 4 5] (apply +)))
(println #"结果: #{r6}")
(println "期望: 15")
(println "")
